...
console.log("yt api poszło")
var scriptUrl = 'https:\/\/www.youtube.com\/s\/player\/31eb286a\/www-widgetapi.vflset\/www-widgetapi.js';
try {
...
var YTConfig;
if(!window["YTConfig"]) YTConfig={"host":"https://localhost:8000"};
if(!YT.loading) {
        YT.loading=1;
        (function(){
            var l=[];
