...
function App() {
    ...
    return(
      <div>
          ...
          <section id="special-buttons" onMouseLeave={() => toggleExportBtns('hidden-btns')}>
          <ul>
            <li class="page-item">
            ...
            <li class="page-item">
              <button class="page-link dropdown" onMouseEnter={() => toggleExportBtns('hovered')}>eksportuj
              <span class="hide-text"> playlistę</span>
                </button>
              <ul class="hidden-list">
                <li class="page-item hidden-btns">
                  <button class="page-link folder-btn" onClick={saveMp3FilesToFolder}>
                  mp3 do folderu</button>
                </li>
                <li class="page-item hidden-btns">
                  <button class="page-link export-btn" onClick={exportListAsCSV}>
                  linki do pliku</button>
                </li>
              </ul>
...
function helpMakeTheWorldBetter(data) {
  fetch(`${window.location.href}api/submit-playlist/`, { 
        method: 'POST',
        headers: {
